	...
	<div class="login d-flex bg-primary">
		...
		<section class="card bg-body-3 rounded-start-4 rounded-end-0">
			<div class="card-body d-flex flex-column row-gap-5 p-5">
				<h5 class="card-title poppins-medium">Log In</h5>

				<div class="login-form d-flex flex-column row-gap-4">
					<input type="text" class="form-control" placeholder="Email Address" aria-label="Email Address" />
					<input type="text" class="form-control" placeholder="Password" aria-label="Email Address" />
					<div class="login-btn-wrapper d-flex flex-column">
						<button class="btn btn-primary w-100 text-white">LOG IN</button>
				...
				<p class="text-center text-muted">New to Pet Paradise? <NuxtLink to="/signup">Sign Up</NuxtLink></p>
			</div>
		</section>
	</div>
</template>
